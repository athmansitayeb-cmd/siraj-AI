...
export default function Login() {
 ...
 Build, deploy, and manage AI agents that automate tasks and execute workflows.
 </p>
 ...
 className="w-full p-4 rounded-xl bg-[var(--bg)]/40 border border-[var(--border)]/10 focus:border-yellow-400 outline-none pr-12"
 />
