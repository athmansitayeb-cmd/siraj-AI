...
export default function Register() {
 ...
 <div className="min-h-screen flex bg-[var(--bg)] text-[var(--text)] relative overflow-hidden">
...
<div className="mt-10 space-y-3 text-sm text-gray-500">
 ...
 <motion.div
 className="w-full max-w-md bg-white/5 backdrop-blur-2xl border border-[var(--border)]/10 rounded-3xl p-10 shadow-2xl relative"
 ...
 className="w-full p-4 rounded-xl bg-[var(--bg)]/40 border border-[var(--border)]/10 focus:border-yellow-400 outline-none transition"
 />
 ...
 className="w-full p-4 rounded-xl bg-[var(--bg)]/40 border border-[var(--border)]/10 focus:border-yellow-400 outline-none transition pr-12"
 />
 ...
 <button className="w-full py-3 rounded-xl border border-[var(--border)]/10 hover:border-yellow-400 transition text-sm">
